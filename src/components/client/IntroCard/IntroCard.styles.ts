...
export const introCardWrapperClasses = mergeRWDClassesHelper({
  [RWD_VARIANTS.base]:
...
export const introCardCircleSVGClasses = mergeRWDClassesHelper({
...
export const introCardImageWrapperClasses = mergeRWDClassesHelper({
...
export const introCardCTABlockClasses = mergeRWDClassesHelper({
  [RWD_VARIANTS.base]: "flex flex-col gap-6 items-center",
  [RWD_VARIANTS.xlarge]:
    "xl:absolute xl:right-[95px] xl:top-[133px] xl:items-start",
});

export const introCardTitleClasses = mergeRWDClassesHelper({
