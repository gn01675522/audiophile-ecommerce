...
export const aboutCardWrapperClasses = mergeClassesHelper({
...
export const aboutCardImageWrapperClasses = mergeClassesHelper({
...
export const aboutCardArticleClasses = mergeClassesHelper({
...
export const aboutCardArticleWrapperClasses = mergeClassesHelper({
  [RWD_VARIANTS.base]: "flex flex-col gap-8",
  [RWD_VARIANTS.xlarge]: "xl:w-[445px] xl:h-[295px] xl:flex-start",
});

export const aboutCardTitleClasses = mergeClassesHelper({
...
export const aboutCardParagraphClasses = mergeClassesHelper({
